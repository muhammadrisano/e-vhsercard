    ...
    <div class="card">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ url('type_area' . '/' . 'CFS') }}">CFS</a></li>
          <li><a class="dropdown-item" href="{{ url('type_area' . '/' . 'SFS') }}">SFS</a></li>
        </ul>
      </div>
      @endif
      @if (session('status'))
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="{{ url('add_area_pengawas') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                  <div class="form-group">
                                    <label for="area" class="form-control-label">Area</label>
                                    <input class="form-control @error('area')
                                    is-invalid
                                    @enderror" type="text" value="{{ old('area') }}" id="area" name="area" required>
                                  </div>
                                  <div class="form-group">
                                    <label for="type" class="form-control-label">Type</label>
                                    <select class="form-control @error('type')
                                    is-invalid
                                    @enderror" id="type" name="type" required>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->positions }}</h6>
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td class="align-middle">
                  <a href="{{ url('detail_pengawas_manager_id' . '/' . $row->id_positions) }}" class="btn btn-success">
