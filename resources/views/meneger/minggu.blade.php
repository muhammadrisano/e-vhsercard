    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Report Per Minggu</li>
        </ol>
        <h6 class="font-weight-bolder mb-0 text-white">Report Per Minggu</h6>
      </nav>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ date('d,F Y',strtotime($row->waktu_laporan_minggu)) }}</h6>
                    </div>
                  </div>
                </td>
                <td class="align-middle">
                  <a href="{{ url('detail_perminggu' . '/' . $row->id_laporan_minggu .'/' . $row->minggu_ke) }}" class="btn btn-success">
