            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Detail Perhari
                        </li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0 text-white">Detail Perhari</h6>
                </nav>
        ...
        <div class="container py-4" style="overflow-x: hidden">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('detail' . '/' . $id . '/' . $hari) }}" class="btn btn-warning">Kembali</a>
                    @if (session('status'))
