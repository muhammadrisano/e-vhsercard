    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Area Mananger</li>
        </ol>
        <h6 class="font-weight-bolder mb-0 text-white">Area Mananger</h6>
      </nav>
      ...
      @if (session('status'))
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Tambah Area Manager</h5>
                                </div>
                                <div class="modal-body">
                                  <form action="{{ url('add_manager_admin') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                  <div class="form-group">
                                    <label for="nama" class="form-control-label">Nama Lengkap</label>
                                    <input class="form-control @error('nama')
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle">
                  ...
                  <div class="modal fade" id="edit{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="{{ url('edit_mananger_admin' . '/' . $row->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                  ...
                  <a href="{{ url('hapus_mananger_admin' . '/' . $row->id) }}" class="btn btn-danger">
