    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Setting</li>
        </ol>
        <h6 class="font-weight-bolder mb-0 text-white">Setting</h6>
      </nav>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex px-2">
                      <div>
                          <img src="{{ asset('assets/img' . '/' . $profile->logo) }}"
                ...
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $profile->nama }}</h6>
                    </div>
                  </div>
                </td>
                <td class="align-middle">
                  <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#edit">
                ...
                <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="{{ url('edit_profile' . '/' . $profile->id_profile) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="img_lama" value="{{ $profile->logo }}">
                                  <div class="form-group">
                                    <label for="nama" class="form-control-label">Nama Aplikasi</label>
                                    <input class="form-control @error('nama')
                                    is-invalid
                                    @enderror" type="text" value="{{ $profile->nama }}" id="nama" name="nama" required>
                                  <div class="form-group">
                                    <label for="img" class="form-control-label">Gambar</label>
                                    <input class="form-control @error('img')
                                      is-invalid
