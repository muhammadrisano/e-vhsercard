    ...
    <div class="card">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ url('type_area_hse' . '/' . 'CFS') }}">CFS</a></li>
          <li><a class="dropdown-item" href="{{ url('type_area_hse' . '/' . 'SFS') }}">SFS</a></li>
        </ul>
      </div>
      @endif
      @if ($eksport)
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ url('print_cfs' . '/' . 'CFS') }}">CFS</a></li>
          <li><a class="dropdown-item" href="{{ url('print_sfs' . '/' . 'SFS') }}">SFS</a></li>
        </ul>
      </div>
      @endif
      @if (session('status'))
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle">
                  <a href="{{ url('detail_pengawas_manager_id_hse' . '/' . $row->id_positions) }}" class="btn btn-success">
