    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Report Area</li>
        </ol>
        <h6 class="font-weight-bolder mb-0 text-white">Report Area</h6>
      </nav>
  ...
  <div class="container py-4" style="overflow-x: hidden">
    <div class="card">
      <div class="card-header">
        <h6>Report Area</h6>
        @if ($area_count)
        <a href="{{ url('eksport') }}" class="btn btn-primary">Print</a>
        @endif
        @if (session('status'))
          ...
          <table class="table align-items-center justify-content-center mb-0 diplay" id="myTable" style="width: 100%">
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Area</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Submitting</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Jumlah Pengawas</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Persentasi</th>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->nama_area }}</h6>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->submitting }}</h6>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->jml_pengawas }}</h6>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->presentase }}</h6>
                    </div>
                  </div>
                </td>
                {{-- <td>
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      <h6 class="mb-0 text-sm">{{ $row->rank }}</h6>
                    </div>
                  </div>
                </td> --}}
              </tr>
