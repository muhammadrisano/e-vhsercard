    ...
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Detail Approval</li>
        </ol>
        <h6 class="font-weight-bolder mb-0 text-white">Detail Approval</h6>
      </nav>
  ...
  <div class="container py-4" style="overflow-x: hidden">
    <div class="card">
      <div class="card-header">
        <a href="{{ url('approval_hse') }}" class="btn btn-warning">Kembali</a>
        @if (session('status'))
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <div class="d-flex px-2">
                    <div class="my-auto">
                      @if ($row->total_persen == 4)
                          <span class="badge bg-gradient-success badge-pill">Sudah</span>
                ...
                <td class="align-middle">
                  <a href="{{ url('detail_approval_point' . '/' . $row->id . '/' . $times) }}" class="btn btn-success">
