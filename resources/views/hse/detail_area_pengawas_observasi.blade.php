  ...
  <div class="container py-4" style="overflow-x: hidden">
    <div class="card">
      <div class="card-header">
        <a href="{{ url('detail_pengawas_manager_id_hse' . '/' . $positions) }}" class="btn btn-warning">Kembali</a>
      @if (session('status'))
          ...
          <table class="table align-items-center justify-content-center mb-0 diplay" id="myTable" style="width: 100%">
            ...
            <tbody>
              ...
              @php
                ...
                $users_akun = DB::table('users')->where('email',$row->hse_nik)->first();
                $positions_akun = DB::table('positions')->where('id_positions',$row->event)->first();
              @endphp
               <tr>
